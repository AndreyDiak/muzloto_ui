  ...
  return (
    <div className="bg-surface-card rounded-2xl p-5 border border-neon-cyan/20">
      ...
      <button
        type="button"
        onClick={onShowQR}
        className="flex items-center justify-center gap-2 w-full py-3 rounded-xl border border-neon-cyan/40 bg-neon-cyan/10 text-neon-cyan hover:bg-neon-cyan/20 font-medium"
      >
