...
export type ClaimVisitRewardResult = ApiClaimVisitRewardResponse;

export async function claimVisitReward(): Promise<ClaimVisitRewardResult> {
  ...
  const res = await fetch(`${backendUrl}/api/achievements/claim-visit-reward`, {
    method: "POST",
    headers: {
